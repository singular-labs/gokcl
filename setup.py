...
REMOTE_MAVEN_PACKAGES = [
    # Build using our own repo with changes
#     #('software.amazon.kinesis', 'amazon-kinesis-client', '2.0.4'),
#     #('software.amazon.kinesis', 'amazon-kinesis-client-multilang', '2.0.4'),

    # Dependencies
    ('org.codehaus.mojo', 'animal-sniffer-annotations', '1.14'),
    ('software.amazon.awssdk', 'annotations', '2.0.6'),
    ('software.amazon.awssdk', 'apache-client', '2.0.6'),
    ('software.amazon.awssdk', 'auth', '2.0.6'),
    ('software.amazon.awssdk', 'aws-core', '2.0.6'),
    ...
    ('software.amazon', 'flow', '1.6'),
    ('com.google.guava', 'guava', '26.0-jre'),
    ('software.amazon.awssdk', 'http-client-spi', '2.0.6'),
    ('org.apache.httpcomponents', 'httpclient', '4.5.5'),
    ('org.apache.httpcomponents', 'httpcore', '4.4.10'),
    ('software.amazon.ion', 'ion-java', '1.2.0'),
    ...
    ('software.amazon.awssdk', 'kinesis', '2.0.6'),
    ('ch.qos.logback', 'logback-classic', '1.1.7'),
    ('ch.qos.logback', 'logback-core', '1.1.7'),
    ('io.netty', 'netty-buffer', '4.1.26.Final'),
    ('io.netty', 'netty-codec', '4.1.26.Final'),
    ('io.netty', 'netty-codec-http', '4.1.26.Final'),
    ('io.netty', 'netty-codec-http2', '4.1.26.Final'),
    ('io.netty', 'netty-common', '4.1.26.Final'),
    ('io.netty', 'netty-handler', '4.1.26.Final'),
    ('software.amazon.awssdk', 'netty-nio-client', '2.0.6'),
    ('com.typesafe.netty', 'netty-reactive-streams', '2.0.0'),
    ('com.typesafe.netty', 'netty-reactive-streams-http', '2.0.0'),
    ('io.netty', 'netty-resolver', '4.1.26.Final'),
    ('io.netty', 'netty-transport', '4.1.26.Final'),
    ('io.netty', 'netty-transport-native-epoll', '4.1.26.Final'),
    ('io.netty', 'netty-transport-native-unix-common', '4.1.26.Final'),
    ('software.amazon.awssdk', 'profiles', '2.0.6'),
    ('com.google.protobuf', 'protobuf-java', '2.6.1'),
    ('org.reactivestreams', 'reactive-streams', '1.0.2'),
    ('software.amazon.awssdk', 'regions', '2.0.6'),
    ('io.reactivex.rxjava2', 'rxjava', '2.1.14'),
    ('software.amazon.awssdk', 'sdk-core', '2.0.6'),
    ('org.slf4j', 'slf4j-api', '1.7.25'),
    ('software.amazon.awssdk', 'utils', '2.0.6')
]
